...
#'Zfull': ('fonts/Zfull-GB.ttf', 16, 16),
    ...
    try:
        while True:
            ...
            lcd.delay(1000)
            lcd.clearLCD()
            lcd.displayImage(disp.txtDisp('Comfortaa:\n'+en_multi, 'Comfortaa', 'xl', resize=1))
            lcd.delay(2000)
            lcd.clearLCD()
            lcd.displayImage(disp.txtDisp('PoiretOne:\n'+en_multi, 'PoiretOne', 'xl', resize=1))
            lcd.delay(2000)
            lcd.clearLCD()
            lcd.displayImage(disp.txtDisp('Rokkitt:\n'+en_multi, 'Rokkitt', 'xl', resize=1))
            lcd.delay(2000)
            lcd.clearLCD()
            lcd.displayImage(disp.txtDisp('Wenq:\n'+en_multi, 'Wenq', 'xl', resize=1))
            lcd.delay(2000)
            lcd.clearLCD()
            lcd.displayImage(disp.txtDisp('NotoSansSC:\n'+en_multi, 'NotoSansSC', 'xl', resize=1))
            lcd.delay(2000)
            lcd.clearLCD()
            lcd.displayImage(disp.txtDisp('NotoSerifSC:\n'+en_multi, 'NotoSerifSC', 'xl', resize=1))
            lcd.delay(2000)
            lcd.clearLCD()
            lcd.displayImage(disp.txtDisp('Zfull:\n'+en_multi, 'Zfull', 'xl', resize=1))
            lcd.delay(2000)
            lcd.clearLCD()
            lcd.displayImage(disp.txtDisp(demo2, 'Wenq', 30, resize=1, align=1))
            lcd.delay(1000)
            lcd.clearLCD()
            lcd.displayImage(disp.txtDisp(zh_multi, 'Wenq', 'xl', resize=1))
            lcd.delay(2000)
            lcd.clearLCD()
            lcd.displayImage(disp.txtDisp(zh_multi, 'NotoSansSC', 'xl', resize=1))
            lcd.delay(2000)
            lcd.clearLCD()
            lcd.displayImage(disp.txtDisp(zh_multi, 'NotoSerifSC', 'xl', resize=1))
            lcd.delay(2000)
            lcd.clearLCD()
            lcd.displayImage(disp.txtDisp(zh_multi, 'Zfull', 'xl', resize=1))
            lcd.delay(2000)
            lcd.clearLCD()
            ...
            lcd.delay(2000)
            lcd.clearLCD()
            lcd.displayImage(disp.txtDisp(en_multi, 'UbuntuMono', 'l', resize=1))
            lcd.delay(2000)
            lcd.clearLCD()
            lcd.displayImage(disp.txtDisp(en_multi, 'RobotoMono', 'l', resize=1))
            lcd.delay(2000)
            lcd.clearLCD()
            lcd.displayImage(disp.txtDisp(en_multi, 'Zfull', 'l', resize=1))
            lcd.delay(2000)
            lcd.clearLCD()
